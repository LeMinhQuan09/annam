...
function __after_setup_theme_action(): void {
	register_nav_menus(
		[
			...
			'productcat-nav' => __( 'Product Cat menu', TEXT_DOMAIN ),
...
function __register_sidebars_action(): void {
	...
	register_sidebar(
		[
			...
			'description'   => __( 'Widgets added here will appear in before footer.', TEXT_DOMAIN ),
			'before_widget' => '<div class="%2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<span>',
			'after_title'   => '</span>',
	...
	register_sidebar(
		[
			'container'     => false,
			'id'            => 'top-product-archive',
			'name'          => __( 'Top Product Archive', TEXT_DOMAIN ),
			'description'   => __( 'Widgets added here will appear in top product archive.', TEXT_DOMAIN ),
			'before_widget' => '<div class="%2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<span>',
			'after_title'   => '</span>',
	...
	register_sidebar(
		[
			'container'     => false,
			'id'            => 'bottom-product-archive',
			'name'          => __( 'Bottom Product Archive', TEXT_DOMAIN ),
			'description'   => __( 'Widgets added here will appear in bottom product archive.', TEXT_DOMAIN ),
			'before_widget' => '<div class="%2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<span>',
			'after_title'   => '</span>',
	...
	register_sidebar(
		[
			'container'     => false,
			'id'            => 'w-cta-sidebar',
			'name'          => __( 'CTA Sidebar', TEXT_DOMAIN ),
			'description'   => __( 'Widgets added here will appear in CTA Sidebar.', TEXT_DOMAIN ),
			'before_widget' => '<div class="%2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<span>',
			'after_title'   => '</span>',
