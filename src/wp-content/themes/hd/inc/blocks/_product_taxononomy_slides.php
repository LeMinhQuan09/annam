...
$number_desktop = $args['number_desktop'];
$number_tablet = $args['number_tablet'];
$number_mobile = $args['number_mobile'];
...
?>
<section class="section carousel-section product-taxonomy-section <?= $fc_css_class ?>">
	<div class="container">
		<?php
		if ( $fc_title ) { echo '<h2 class="heading-title">' . $fc_title . '</h2>'; }
        if ( $fc_product_cat ) : ?>
        <div class="swiper-container carousel-product-cat">
	        <?php
	        $swiper_class = '';
	        $_data = [
		        'loop' => true,
