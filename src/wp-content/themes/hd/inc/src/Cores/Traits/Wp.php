...
trait Wp {
	 ...
	 * @return string|null
	 */
	public static function postImageSrc( $post = null, string $size = 'widescreen' ): ?string {
	 ...
	 * @return string|null
	 */
	public static function attachmentImageSrc( $attachment_id, string $size = 'widescreen' ): ?string {
	 ...
	 * @return string
	 */
	public static function iconImage( $attachment_id, string $size = 'widescreen', string|array $attr = '' ): string {
	 ...
	 * @return string|null
	 */
	public static function acfTermThumb( $term, $acf_field_name = null, string $size = "widescreen", bool $img_wrap = false, string|array $attr = '' ): ?string {
		if ( is_numeric( $term ) ) {
			$term = get_term( $term );
		}
