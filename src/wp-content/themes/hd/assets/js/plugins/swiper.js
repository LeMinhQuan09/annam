...
"use strict";
/*!*************************************************************!*\
  !*** ./wp-content/themes/hd/resources/js/plugins/swiper.js ***!
  \*************************************************************/
__webpack_require__.r(__webpack_exports__);
...
var spgSwipers = function spgSwipers() {
  ...
  swiperElements.forEach(function (el, index) {
    ...
    var firstImageIframe = w_images === null || w_images === void 0 ? void 0 : w_images.querySelector('.swiper-images-video iframe');
    var firstImageVideo = w_images === null || w_images === void 0 ? void 0 : w_images.querySelector('.swiper-images-video');
    ...
    var lastAddedSlideIndex = null;
    var galleryWrappers = document.querySelectorAll('.woocommerce-product-gallery__wrapper .swiper-slide');
